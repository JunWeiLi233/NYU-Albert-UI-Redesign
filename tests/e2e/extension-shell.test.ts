...
test("exposes task-first discovery at every supported width and delegates through native Albert controls", async () => {
  ...
  for (const [query, destinationName] of [
    ...
    ["Employers", "Open Wasserman"],
    ["Employer Services", "Open Wasserman"],
    ["Alumni Career Services", "Open Wasserman"],
    ["Campus Partners", "Open Wasserman"],
    ...
    ["Visas for NYU Study Abroad", "Open OGS"],
    ["Residence Services at the School of Law", "Open Law Housing"],
    [
      "housing and dining",
      "Open Other Resources — NYU services, offices, and support",
    ],
    ...
    ["Graduation and Diplomas", "Open Academics — Plan courses, manage enrollment, meet your advisor, and track degree progress"],
    ["Tuition and Fee Rates", "Open Finances — Check balances, pay tuition, view bills, and manage financial aid"],
    ["How Billing and Payment Work at NYU", "Open Finances — Check balances, pay tuition, view bills, and manage financial aid"],
    ["Payment Due Dates", "Open Finances — Check balances, pay tuition, view bills, and manage financial aid"],
    ["Financial Aid Refunds", "Open Finances — Check balances, pay tuition, view bills, and manage financial aid"],
    ["Housing Payments and Tax Documents", "Open Finances — Check balances, pay tuition, view bills, and manage financial aid"],
    [
      "new student",
      "Open Other Resources — NYU services, offices, and support",
    ],
    ...
    ["Browse available classes", "Open Find Classes — Search by subject, course number, title, or instructor"],
    ["Add and validate your classes to your Shopping Cart", "Open Find Classes — Search by subject, course number, title, or instructor"],
    ["Enroll in classes for the next term at your designated registration day and time", "Open Find Classes — Search by subject, course number, title, or instructor"],
    ["Check your registration date and time", "Open When Can I Register? — Check when you can register"],
    ["Make sure you don’t have any registration holds that will block you from registering", "Open Check Holds — Review current registration holds"],
    ["Meet with your advisor to discuss your class schedule and review your degree requirements", "Open Academics — Plan courses, manage enrollment, meet your advisor, and track degree progress"],
    ["Make sure your contact information is up-to-date in Albert", "Open Personal Info — Review official details and update contact information"],
    ["Check your Bursar and Financial Aid Accounts", "Open Finances — Check balances, pay tuition, view bills, and manage financial aid"],
    ...
    ["Update your student records", "Open Personal Info — Review official details and update contact information"],
    ["Updating Your Student Records", "Open Personal Info — Review official details and update contact information"],
    ["Managing Guest Users", "Open Personal Info — Review official details and update contact information"],
    ["New York State Tuition Assistance Program (TAP)", "Open Grades & Transcripts — View grades, get transcripts, and prove enrollment"],
    ["Tech Checklist for New Students", "Open Other Resources — NYU services, offices, and support"],
    ["New Student Registration Guide", "Open Other Resources — NYU services, offices, and support"],
    ["Manage Guest Users in Albert", "Open Other Resources — NYU services, offices, and support"],
    ["Certify Your Eligibility for NY State TAP", "Open Other Resources — NYU services, offices, and support"],
    ["Resources for Military-Connected Students", "Open Other Resources — NYU services, offices, and support"],
    ["Certify Your VA Benefits", "Open Other Resources — NYU services, offices, and support"],
    ...
    ["Find tips for remote learning", "Open NYU Connect"],
    ["Centralized online platform", "Open NYU Connect"],
